...
public class Pager {
	...
	public void setOutStr(String action) {
		try {
			...
			sb.append("		<tr>");
			sb.append("       <td width=\"120\" height=\"40\" align=\"center\" valign=\"middle\">跳转到第&nbsp;<input name=\"pageNum\" type=\"text\" value=\""+currPage+"\" class=\"ts_box4\"   size=\"1\" style=\"text-align:center;width:40px\">&nbsp;页</td>");
	...
	public void setOutStrNoTable(String action) {
		try {
			...
			sb.append(" 跳转到第&nbsp;<input name=\"pageNum\" type=\"text\" value=\""+currPage+"\" class=\"ts_box4\"   size=\"1\" style=\"text-align:center;width:40px\">&nbsp;页");
