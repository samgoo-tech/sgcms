...
public class FreemarkerPager {
	...
	public String getTablePageStr() {
		...
		sb.append("		<tr>");
		sb.append("       <td width=\"120\" height=\"40\" align=\"center\" valign=\"middle\">第&nbsp;<input id=\"pageNum\" type=\"text\" value=\""+currPage+"\" class=\"ts_box4\"  size=\"1\" style=\"text-align:center;width:40px\">&nbsp;页</td>");
	...
	public String getFormTablePageStr() {
		...
		try {
			...
			sb.append("	  <td width=\"35%\" height=\"40\" align=\"center\" valign=\"middle\"><table border=\"0\" cellspacing=\"0\" cellpadding=\"0\">");
			sb.append("		<tr>");
			sb.append("       <td width=\"120\" height=\"40\" align=\"center\" valign=\"middle\">第&nbsp;<input name=\"pageNum\" type=\"text\" value=\""+currPage+"\" class=\"ts_box4\"   size=\"1\" style=\"text-align:center;width:40px\">&nbsp;页</td>");
	...
	public String getFormPageStr() {
		...
		try {
			...
			sb.append("第&nbsp;<input name=\"pageNum\" type=\"text\" value=\""+currPage+"\" class=\"ts_box4\" size=\"1\" style=\"text-align:center;width:40px\">&nbsp;页&nbsp;");
	...
	public String getPageStr() {
		...
		sb.append("第&nbsp;<input id=\"pageNum\" type=\"text\" value=\""+currPage+"\" class=\"ts_box4\"  size=\"1\" style=\"text-align:center;width:40px\">&nbsp;页&nbsp;");
